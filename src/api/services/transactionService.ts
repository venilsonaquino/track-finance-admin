...
export const TransactionService = {
  ...
  getTransactions: (startDate: string, endDate: string, categoryIds?: string[] | null) => HttpClient.get(`/transactions?start_date=${startDate}&end_date=${endDate}&category_ids=${categoryIds}`),
